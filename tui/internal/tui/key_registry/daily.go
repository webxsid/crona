...
func RegisterDaily[M tea.Model, V comparable, P comparable](r *Router[M, V, P], view V, issuesPane, habitsPane P, one, two, prevDay, nextDay, today, exportDaily, checkout, editHabit, failHabit, toggleHabit Handler[M]) {
