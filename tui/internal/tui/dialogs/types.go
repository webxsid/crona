...
func Render(theme Theme, state controllerpkg.State) string {
	...
	case "confirm_delete",
		...
		"export_report",
		"export_summary_period",
		"export_preset",
		"export_summary_output",
		"export_summary_range",
		"export_scope",
		"export_calendar_repo",
	...
	logger.Infof(
		"dialogs.Render kind=%q matched=%q width=%d rendered_len=%d",
		state.Kind,
		matched,
		state.Width,
		len(rendered),
