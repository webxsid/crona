...
func Resolve(action dialogpkg.Action, state State, deps Deps) tea.Cmd {
	r := New[dialogpkg.Action, tea.Cmd]()
	r.Register("create_scratchpad", func(action dialogpkg.Action) tea.Cmd { return deps.CreateScratchpad(action.Name, action.Path) })
	r.Register("create_repo", func(action dialogpkg.Action) tea.Cmd { return deps.CreateRepo(action.Name, action.Description) })
	r.Register("edit_repo", func(action dialogpkg.Action) tea.Cmd {
		return deps.UpdateRepo(action.RepoID, action.Name, action.Description)
	})
	r.Register("create_stream", func(action dialogpkg.Action) tea.Cmd {
		return deps.CreateStream(action.RepoID, action.Name, action.Description)
	})
	r.Register("edit_stream", func(action dialogpkg.Action) tea.Cmd {
		return deps.UpdateStream(action.RepoID, action.StreamID, action.Name, action.Description)
	})
	r.Register("create_issue_meta", func(action dialogpkg.Action) tea.Cmd {
		return deps.CreateIssueOnly(action.StreamID, action.Title, action.Description, action.Estimate, action.DueDate)
	})
	r.Register("create_habit", func(action dialogpkg.Action) tea.Cmd {
	...
	r.Register("edit_habit", func(action dialogpkg.Action) tea.Cmd {
	...
	r.Register("create_issue_default", func(action dialogpkg.Action) tea.Cmd {
	...
	r.Register("checkout_context", func(action dialogpkg.Action) tea.Cmd {
		return deps.CheckoutContext(action.RepoID, action.RepoName, action.StreamID, action.StreamName)
	})
	r.Register("create_checkin", func(action dialogpkg.Action) tea.Cmd { return checkinCmd(action, deps) })
	r.Register("edit_checkin", func(action dialogpkg.Action) tea.Cmd { return checkinCmd(action, deps) })
	r.Register("edit_issue", func(action dialogpkg.Action) tea.Cmd {
	...
	r.Register("complete_habit", func(action dialogpkg.Action) tea.Cmd {
	...
	r.Register("export_report", func(action dialogpkg.Action) tea.Cmd { return exportCmd(action, state, deps) })
	...
	r.Register("complete_onboarding", func(action dialogpkg.Action) tea.Cmd {
	...
	r.Register("change_issue_status", func(action dialogpkg.Action) tea.Cmd {
	...
	r.Register("stash_session", func(action dialogpkg.Action) tea.Cmd {
		return deps.StashFocusSession(dialogpkg.ValueOrEmpty(action.Note))
	})
	r.Register("change_issue_status_and_end_session", func(action dialogpkg.Action) tea.Cmd {
	...
	r.Register("set_issue_todo_date", func(action dialogpkg.Action) tea.Cmd {
		due := ""
...
func checkinCmd(action dialogpkg.Action, deps Deps) tea.Cmd {
...
func exportCmd(action dialogpkg.Action, state State, deps Deps) tea.Cmd {
...
func patchSettingCmd(action dialogpkg.Action, state State, deps Deps) tea.Cmd {
...
func deleteCmd(action dialogpkg.Action, state State, deps Deps) tea.Cmd {
	r := New[dialogpkg.Action, tea.Cmd]()
	r.Register("repo", func(action dialogpkg.Action) tea.Cmd { return deps.DeleteRepo(dialogpkg.ParseNumericID(action.ID)) })
	r.Register("stream", func(action dialogpkg.Action) tea.Cmd {
		return deps.DeleteStream(action.RepoID, dialogpkg.ParseNumericID(action.ID))
	})
	r.Register("issue", func(action dialogpkg.Action) tea.Cmd {
		return deps.DeleteIssue(dialogpkg.ParseNumericID(action.ID), action.StreamID, state.DashboardDate)
	})
	r.Register("habit", func(action dialogpkg.Action) tea.Cmd {
		return deps.DeleteHabit(dialogpkg.ParseNumericID(action.ID), action.StreamID, state.DashboardDate)
	})
	r.Register("checkin", func(action dialogpkg.Action) tea.Cmd { return deps.DeleteDailyCheckIn(action.ID) })
	r.Register("report", func(action dialogpkg.Action) tea.Cmd {
