...
### Changed
- Daily momentum and Wellbeing help text now stay aligned around the same standard key labels.
- The settings row handling and release metadata checks now use the merged week-start layout and version sources of truth.
