...
| `dashboard.focus_score_range` | One focus-score result per date in an inclusive range | `dto.DateRangeQuery` | `types.FocusScoreRangeDay[]` | None | TUI, macOS companion | Yes |
