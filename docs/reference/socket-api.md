...
The response contains an entry for every date, including dates without activity:
...
`hasData` distinguishes an empty day from a calculated zero score. Date-only
