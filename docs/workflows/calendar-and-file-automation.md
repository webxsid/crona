...
Keep Crona's boundary simple: it writes useful local files, and the tools you already use can read them. This makes calendar and notes automation predictable without handing your work to a cloud connector.
...
Next: [Exports and Reports](exports-and-reports.md) for the report types and formats Crona can generate.
